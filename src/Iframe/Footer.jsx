      ...
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className="flex-1 flex flex-col justify-start ">
          ...
          <img
            src={logo}
            alt="logo"
            className="w-[244px] h-[70px] object-obtain "
          />
          <p className={`${styles.paragraph} mt-4 max-w-[380px] `}>
            A new way to build customer relationships easy, secure and reliable.
          </p>
        </div>

        <div className="flex-[1.5] w-full flex flex-row md:justify-end justify-start flex-wrap md:mt-0 mt-10 relative ">
